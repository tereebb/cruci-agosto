const cruciverbaData = [
    { parola: "COllaborazione", start: [0, 2], direzione: "orizzontale", 
descrizione: "Sinonimo di cooperazione.", classe: "blu", bloccate: [0, 7]},
    { parola: "MENSA", start: [1, 4], direzione: "orizzontale", 
descrizione: "Spazio dedicato alla pausa pranzo.", classe: "azzurro", bloccate: [1, 7]},
    { parola: "COMUNICARE", start: [2, 5], direzione: "orizzontale", 
descrizione: "Necessario tra lavoratori(verbo).", classe: "arancione", bloccate: [3, 4]},
    { parola: "COESIONE", start: [3, 3], direzione: "orizzontale", 
descrizione: "Unione stretta di elementi che formano un insieme omogeneo e ben legato.", classe: "blu", bloccate: [1, 6]},
    { parola: "COMFORT", start: [4, 4], direzione: "orizzontale", 
descrizione: "Stato di benessere e agio fisico o mentale (ing.).", classe: "azzurro", bloccate: [4]},
{ parola: "INNOVATIVA", start: [5, 3], direzione: "orizzontale", 
descrizione: "Azienda che porta novità sul mercato.", classe: "arancione", bloccate: [2, 6]},
    { parola: "RAPPORTI", start: [6, 2], direzione: "orizzontale", 
descrizione: "Tra i colleghi e con il capo.", classe: "blu", bloccate: [2, 6]},
